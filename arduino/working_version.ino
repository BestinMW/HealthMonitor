...
void loop() {
  ...
  if (millis() - lastPrint > printInterval) {
    ...
    Serial.print("Ambient °C: "); Serial.print(ambientTemp); Serial.println(" °C");
    Serial.print("Object °C: "); Serial.print(objectTemp); Serial.println(" °C");
    Serial.print("Ambient °F: "); Serial.print(ambientTemp * 9 / 5 + 32); Serial.println(" F");
    Serial.print("Object °F: "); Serial.print(objectTemp * 9 / 5 + 32); Serial.println(" F");
    Serial.println();
  }
}